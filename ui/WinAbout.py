...
class Ui_WinAbout(object):
    def setupUi(self, WinAbout):
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("f:\\MyProgram\\Software\\HystereticCurveProcess\\ui\\../logo.png"))
    ...
    def retranslateUi(self, WinAbout):
        ...
        self.label_3.setText(_translate("WinAbout", "<html><head/><body><p><span style=\" font-size:14pt; color:#000000;\">Hysteretic curve process<br/>滞回曲线处理软件</span></p><p><span style=\" font-size:14pt; color:#000000;\">Copyright (c) data<br/>开发者：列文琛<br/>版本：Version<br/>联系邮箱：438171766@qq.com<br/>QQ：438171766</span></p></body></html>"))
